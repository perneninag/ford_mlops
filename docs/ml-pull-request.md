...
Links:
* [Staging model in UC](https://dbc-c5a590ce-ba8d.cloud.databricks.com/explore/data/models/staging/my_mlops_project/my_mlops_project-model)
* [Prod model in UC](https://your-prod-workspace.cloud.databricks.com/explore/data/models/prod/my_mlops_project/my_mlops_project-model)
. 

...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://dbc-c5a590ce-ba8d.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://your-prod-workspace.cloud.databricks.com#setting/accounts). 
